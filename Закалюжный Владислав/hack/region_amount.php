    ...
    for($district=0;$district<count($_DISTRICTS);$district++)
    {
        ...
        echo "<div style='background-color:white;border-top:3px solid black; display:flex; justify-content:space-between;'>"
          ...
          $_DISTRICTS[$district]."</div>"."<div class='amount'>".$mass_tranport[$district]."</div>".
            "<div class='coll'>". $amounts[0]."</div>"."<div class='coll'>". $amounts[1]."</div>"."<div class='coll' '>". $amounts[2]."</div>"."<div class='coll'>". $amounts[3]."</div>"."<div class='coll'>". $amounts[4]."</div>"."<div class='coll' >". $amounts[5]."</div>"."<div class='coll' >". $amounts[6]."</div>"."<div class='coll'>". $amounts[7]."</div>"."<div class='coll'>". $amounts[8]."</div>"."<div class='coll'>". $amounts[9]."</div>"."<div class='coll'>". $amounts[10]."</div>"."<div class='coll'>". $amounts[11]."</div>".
        "</div>";
